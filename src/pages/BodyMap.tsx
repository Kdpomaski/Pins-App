                ...
                return (
                  ...
                  >
                    {selectedCompound && lastDate && (
                      <span className="pointer-events-none absolute left-1/2 top-full mt-1 -translate-x-1/2 whitespace-nowrap rounded bg-black/80 px-1.5 py-0.5 text-[9px] font-medium text-white opacity-0 group-hover:opacity-100 transition-opacity hidden sm:block">
                        {lastDate}
                      </span>
                    )}
                  </button>
