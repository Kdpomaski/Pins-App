...
export const bodySites: BodySite[] = [
  // Front
  { id: "left-deltoid", label: "Left Deltoid", view: "front", cx: 37, cy: 23 },
  { id: "right-deltoid", label: "Right Deltoid", view: "front", cx: 63, cy: 23 },
  ...
  { id: "mid-left-abdomen", label: "Mid Left Abdomen", view: "front", cx: 47, cy: 38 },
  { id: "mid-right-abdomen", label: "Mid Right Abdomen", view: "front", cx: 53, cy: 38 },
  { id: "lower-left-abdomen", label: "Lower Left Abdomen", view: "front", cx: 47, cy: 42 },
  { id: "lower-right-abdomen", label: "Lower Right Abdomen", view: "front", cx: 53, cy: 42 },
  { id: "left-flank", label: "Left Flank", view: "front", cx: 40, cy: 45 },
  { id: "right-flank", label: "Right Flank", view: "front", cx: 60, cy: 45 },
  { id: "left-wrist", label: "Left Wrist", view: "front", cx: 22, cy: 45 },
  { id: "right-wrist", label: "Right Wrist", view: "front", cx: 78, cy: 45 },
  { id: "left-quadriceps", label: "Left Quadriceps", view: "front", cx: 44, cy: 53 },
  { id: "right-quadriceps", label: "Right Quadriceps", view: "front", cx: 58, cy: 53 },
  { id: "left-knee", label: "Left Knee", view: "front", cx: 42, cy: 60 },
  { id: "right-knee", label: "Right Knee", view: "front", cx: 58, cy: 60 },
  { id: "left-ankle", label: "Left Ankle", view: "front", cx: 42, cy: 82 },
  { id: "right-ankle", label: "Right Ankle", view: "front", cx: 58, cy: 82 },
  // Back
